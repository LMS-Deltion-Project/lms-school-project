globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///web/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///web/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseStatus, getRequestHeader, setResponseHeader, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file:///web/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///web/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///web/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///web/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///web/node_modules/ofetch/dist/node.mjs';
...
import { parseURL, withoutBase, joinURL, withQuery } from 'file:///web/node_modules/ufo/dist/index.mjs';
...
const getClientManifest = () => import('/web/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/web/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
